...
<head>
    ...
    <!--====== Title ======-->
    <title>Gading Bakery</title>

    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="assets/images/logo-gading.png" type="image/png">
...
<body>
    ...
    <div class="side-menu__block">
        ...
        <div class="side-menu__block-inner ">
            <div class="side-menu__top justify-content-end">
                ...
                <a href="#" class="side-menu__toggler side-menu__close-btn"><img src="assets/images/close.png"
                        alt=""></a>
            </div><!-- /.side-menu__top -->
                    ...
                    <div class="col-lg-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light ">
                                <a class="navbar-brand" href="/"><img src="assets/images/logo-gading.png"
                                        alt="" style="width:70px"></a> <!-- logo -->
                                <a class="navbar-brand-2" href="/"><img src="assets/images/logo-gading.png"
                                        alt="" style="width:70px"></a> <!-- logo -->
                                <span class="side-menu__toggler"><i
                                ...
                                <div class="collapse navbar-collapse sub-menu-bar main-nav__main-navigation"
                                    ...
                                    <ul class="navbar-nav m-auto main-nav__navigation-box">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link page-scroll" href="#maps">Maps</a>
                                        </li>
                                    </ul>
                                </div> <!-- navbar collapse -->
                ...
                <div class="col-lg-12">
                    <div class="features-btn">
                        <ul class="nav nav-pills d-flex justify-content-between" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active text-center" id="pills-1-tab" data-toggle="pill"
                                    href="#pills-1" role="tab" aria-controls="pills-1" aria-selected="true">
                                    <i class="flaticon-responsive"><img src="assets/images/features-shape.png"
                                            alt="shape"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-2-tab" data-toggle="pill" href="#pills-2"
                                    ...
                                    <i class="flaticon-computer-graphic"><img src="assets/images/features-shape.png"
                                            alt="shape"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-3-tab" data-toggle="pill" href="#pills-3"
                                    ...
                                    <i class="flaticon-seo-and-web"><img src="assets/images/features-shape.png"
                                            alt="shape"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-4-tab" data-toggle="pill" href="#pills-4"
                                    ...
                                    <i class="flaticon-development"><img src="assets/images/features-shape.png"
                                            alt="shape"></i>
                                    <span>Dashboard</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-5-tab" data-toggle="pill" href="#pills-5"
                                    ...
                                    <i class="flaticon-app-development"><img src="assets/images/features-shape.png"
                                            alt="shape"></i>
                        ...
                        <div class="float-download">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="float-download-bar d-block d-lg-flex justify-content-between align-items-center wow fadeInUp"
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-thumb  wow fadeInLeft" data-wow-duration="1500ms">
                        <img src="assets/images/mobile-1.png" alt="" style="width: 400px">
                        <div class="about-thumb-1">
                            <img src="assets/images/ipad-1.png" alt="" style="height: 200px; ">
                        </div>
                        <div class="about-thumb-2">
                            <img src="assets/images/ipad-2.png" alt="" style="height: 200px; ">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="section-title">
                            <h3 class="title">Gading Bakery App</h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="maps" class="customers-area pt-120 pb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-9"
                    ...
                    <div class="customers-content"
                        style="align-content: center; display: flex;flex-direction: column;">
                        <div class="item">
                            <p>Stand Pasar #15 Sebelah Jembatan Dukun, Kalirejo, Kec. Dukun,
                ...
                <div class="col-lg-6">
                    <div class="customers-thumb wow fadeInLeft" data-wow-duration="1500ms">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.0003110812077!2d112.50416421057604!3d-7.009244992962946!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e77e4918bc0669b%3A0x2e5e2eae8aad7699!2sBakery%20Gading!5e0!3m2!1sid!2sid!4v1714925339333!5m2!1sid!2sid"
                            width="600" height="450" style="border:0; display: block;margin-right: 100px"
            ...
            <div class="row">
                <div class="col-lg-6 col-md-7 col-sm-9">
                    <div class="footer-widget footer-widget-about">
                        <a href="#"><img src="assets/images/logo-gading.png" style="width: 60px"
                                alt="logo"></a>
                        <p>Selamat datang di Gading Bakery, sebagai toko roti yang telah melayani pelanggan dengan
                            bangga, kami di Gading Bakery menghadirkan berbagai pilihan roti, kue, dan camilan.</p>
                    </div>
